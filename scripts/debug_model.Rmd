...
sec_debug_long %>%
  ...
  geom_bar(stat = "identity", position = "stack") +
  labs(y = "#/cell", title = "Location of V165 in Primary Tumor with original model parameters", x = "")
```
...
sec_debug2 %>%
  ...
  labs(x = "time", y = "# R2/cell",
       title = "Concentration of Free R2 in Primary tumor",
       color = "kprod_R2") +
  facet_wrap(~q_V165, scales = "free_y", labeller = "label_both")+
  theme(legend.position = c(1,0), legend.justification = c(1,0))
...
sec_debug2 %>%
  ...
  labs(x = "time", y = "# Bound R2/cell",
       title = "Concentration of Bound R2 in Primary tumor",
       color = "kprod_R2") +
  facet_wrap(~q_V165, scales = "free_y", labeller = "label_both")+
  theme(legend.position = c(1,0), legend.justification = c(1,0))
